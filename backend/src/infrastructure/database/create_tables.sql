-- Script para CREAR todas las tablas con UTF-8
-- Ejecuta este script DESPUÉS de drop_tables.sql
...
SELECT 'Todas las tablas han sido creadas con UTF-8' AS mensaje;
